...
def homeAdmin():
    ...
    Button(mainframe, text = "Clear", width = 12, bg = "#41404A", fg = "#FFFFFF", font = ("Berlin Sans FB", 14), cursor="hand2", relief=GROOVE, command = lambda: searchEntry.delete(0, END)).grid(row=4, column=4, stick=(E), padx=28)
...
def bookProcured():
    ...
    Button(addTransF, text="Add", command=addTrans, width=17, font = ("Berlin Sans FB", 12)).grid(row=10, column=4, padx=20, pady=10)
    ...
    Button(modTransF, text="Modify", command=modTrans, width=17, font = ("Berlin Sans FB", 12)).grid(row=10, column=4, padx=20, pady=10)
    ...
    Button(delTransF, text="Remove", command=delTrans, width=17, font = ("Berlin Sans FB", 12)).grid(row=4, column=4, padx=20, pady=40)
...
def bookReserved():
    ...
    Button(addResF, text="Add", command=addRes, width=17, font = ("Berlin Sans FB", 12)).grid(row=6, column=2, padx=20, pady=40)
    ...
    Button(modResF, text="Modify", command=modRes, width=17, font = ("Berlin Sans FB", 12)).grid(row=6, column=2, padx=20, pady=40)
    ...
    Button(delResF, text="Remove", command=delRes, width=17, font = ("Berlin Sans FB", 12)).grid(row=4, column=2, padx=20, pady=40)
